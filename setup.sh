...
echo -e "$ORANGE━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"$NC
echo -e "$Lred                 ⏩ Autoscript By YokkoEddy"$NC
echo -e "$ORANGE━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"$NC
...
VALIDITY() {
    ...
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32Congratulations! You can use AUTOSCRIPT By YokkoEddy..\e[0m"
        sleep 5
    else
...
VALIDITY() {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/${GitUser}/allow/main/ipvps.conf | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mCongratulations! You can use AUTOSCRIPT By YokkoEddy..\e[0m"
        sleep 5
    else
        echo -e "\e[31mYOUR SCRIPT HAS EXPIRED!\e[0m"
        echo -e "\e[31mPlease renew your ipvps first\e[0m"
...
echo -e "\e[1;32m══════════════════Autoscript By YokkoEddy══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|         PREMIUM BY YokkoEddy.            |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
